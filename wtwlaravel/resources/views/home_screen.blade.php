        ...
        <div class="row justify-content-start">
                <div class="col-md-6">
                    ...
                    <map name="Map" id="Map">
                        ...
                        <area alt="Helsingborg" title="Helsingborg" coords="67,236,10" shape="circle" class="1 1City">
                        <area alt="Ängelholm" title="Ängelholm" coords="113,141,10" shape="circle" class="1 1City">
                        <area alt="Båstad" title="Båstad" coords="119,43,10" shape="circle" class="1 1City">
                        <area alt="Örkelljunga" title="Örkelljunga" coords="231,120,10" shape="circle" class="1 1City">
                        <area alt="Perstorp" title="Perstorp" coords="253,203,10" shape="circle" class="1 1City">
                        <area alt="Klippan" title="Klippan" coords="171,209,10" shape="circle" class="1 1City">
                        <area alt="Svalöv" title="Svalöv" coords="175,304,10" shape="circle" class="1 1City">
                        <area alt="Landskrona" title="Landskrona" coords="109,342,10" shape="circle" class="1 1City">
                        ...
                        <area alt="Kristianstad" title="Kristianstad" coords="525,263,10" shape="circle" class="2 2City">
                        <area alt="Åhus" title="Åhus" coords="551,327,10" shape="circle"class="2 2City">
                        <area alt="Degeberga" title="Degeberga" coords="496,367,10" shape="circle"class="2 2City">
                        <area alt="Tollarp" title="Tollarp" coords="464,317,10" shape="circle"class="2 2City">
                        <area alt="Sösdala" title="Sösdala" coords="403,224,10" shape="circle"class="2 2City">
                        <area alt="Hässleholm" title="Hässleholm" coords="432,176,10" shape="circle"class="2 2City">
                        <area alt="Broby" title="Broby" coords="520,137,10" shape="circle"class="2 2City">
                        <area alt="Bromölla" title="Bromölla" coords="615,234,10" shape="circle"class="2 2City">
                        ...
                        <area alt="Eslöv" title="Eslöv" coords="253,336,10" shape="circle" class="3 3City">
                        <area alt="Stehag" title="Stehag" coords="275,314,10" shape="circle" class="3 3City">
                        <area alt="Höör" title="Höör" coords="311,295,10" shape="circle" class="3 3City">
                        <area alt="Fulltofta" title="Fulltofta" coords="333,320,10" shape="circle" class="3 3City">
                        <area alt="Hörby" title="Hörby" coords="355,337,10" shape="circle" class="3 3City">
                        <area alt="Långaröd" title="Långaröd" coords="403,382,10" shape="circle" class="3 3City">
                        <area alt="Östraby" title="Östraby" coords="336,399,10" shape="circle" class="3 3City">
                        <area alt="Hurva" title="Hurva" coords="287,364,10" shape="circle" class="3 3City">
                        ...
                        <area alt="Malmö" title="Malmö" coords="159,484,10" shape="circle" class="4 4City">
                        <area alt="Lund" title="Lund" coords="197,444,10" shape="circle" class="4 4City">
                        <area alt="Revingehed" title="Revingehed" coords="280,443,10" shape="circle" class="4 4City">
                        <area alt="Svedala" title="Svedala" coords="209,531,10" shape="circle" class="4 4City">
                        <area alt="Skurup" title="Skurup" coords="283,542,10" shape="circle" class="4 4City">
                        <area alt="Smygehamn" title="Smygehamn" coords="257,621,10" shape="circle" class="4 4City">
                        <area alt="Trelleborg" title="Trelleborg" coords="192,607,10" shape="circle" class="4 4City">
                        <area alt="Höllviken" title="Höllviken" coords="135,589,10" shape="circle" class="4 4City">
                        ...
                        <area alt="Ystad" title="Ystad" coords="396,584,10" shape="circle" class="5 5City">
                        <area alt="Sjöbo" title="Sjöbo" coords="360,477,10" shape="circle" class="5 5City">
                        <area alt="Ravlunda" title="Ravlunda" coords="497,434,10" shape="circle" class="5 5City">
                        <area alt="Kivik" title="Kivik" coords="520,464,10" shape="circle" class="5 5City">
                        <area alt="Simrishamn" title="Simrishamn" coords="554,530,10" shape="circle" class="5 5City">
                        <area alt="Hammenhög" title="Hammenhög" coords="496,558,10" shape="circle" class="5 5City">
                        <area alt="Kåseberga" title="Kåseberga" coords="472,608,10" shape="circle" class="5 5City">
                        <area alt="Tomelilla" title="Tomelilla" coords="441,523,10" shape="circle" class="5 5City">
