        ...
        <div class="row justify-content-end">
            <div class="col col-md-3">
                <div class="text-right">
                    <a href="#" data-toggle="popover" data-trigger="focus" title="Instruktioner!" data-content="På den här sidan finns det instruktioner om hur du kan spela Walk The Ward. Använd gärna Tillbaka knappen om du vill gå tillbaka och läsa igen syftet med spelet. Annars kan du klicka på Fortsätt knapp när du läst och förstått instruktionerna och gå vidare. " style="white-space:nowrap;"><img src="{{url('/')}}/images/icon-question.png" width="70px" id="question-mark"></a> 
                </div>
            </div>
        </div>
