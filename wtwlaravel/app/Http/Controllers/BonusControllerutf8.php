    ...
    */
    public function index(Request $request, $id)
    {
        ...
        if (mb_strlen($bonusGameLetters, 'utf-8') > 5) {
            ...
            $bonusGameLettersShuffled= mb_str_shuffle($bonusGameLetters);

            // ex. esnbr (5 slumpmässiga bokstäver från helsingborg)
            $bonusGameLettersShuffledCut = mb_substr($bonusGameLettersShuffled, 0, 5, 'utf-8');
            ...
            while ($fiveTimes < 5) {
                $bonusGameLettersRemain = mb_ereg_replace($bonusGameLettersShuffledCut[$fiveTimes],"_",$bonusGameLettersRemain);
                $fiveTimes ++;
            }
        ...
        while ( $whileBonusUnder12Int < 12) {
            $charRand = mb_convert_encoding(chr(rand(65,90)), 'utf-8');
        ...
        $bonusGameLettersShuffledUpper = mb_strtoupper($bonusGameLettersShuffled, 'utf-8');
        // Skapar en lista av bokstäverna
        // $bonusGameLettersArray = str_split($bonusGameLettersShuffledUpper);
        $bonusGameLettersArray = preg_split('//u', $bonusGameLettersShuffledUpper, null, PREG_SPLIT_NO_EMPTY);
